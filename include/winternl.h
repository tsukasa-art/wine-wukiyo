...
typedef enum _MEMORY_INFORMATION_CLASS {
    ...
    MemoryWineWow64TranslatedInformation = 1005,
    MemoryWineProcessVmMachineInformation = 1006,
    MemoryWineTranslatedViewInformation = 1007, /* paired native implementation required */
#endif
