...
#define NATIVE_GUARD_STACK_SIZE 0x14000
struct thread_data
{
    TEB         *teb;               /* TEB */
...
extern NTSTATUS load_package_graph_snapshot( int fd, data_size_t size,
...
extern BOOL virtual_is_arm64ec_low_buffer( const void *addr, size_t size );
extern ssize_t virtual_locked_arm64ec_file_io( int fd, void *addr, size_t size, off_t offset,
...
extern NTSTATUS virtual_resolve_native_guard( void *args );
extern NTSTATUS virtual_get_exception_stack( void *args );
extern NTSTATUS virtual_prepare_shared_stack( void *args );
