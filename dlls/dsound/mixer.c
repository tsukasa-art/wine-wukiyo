...
/* Saturate the IEEE-float mix before it reaches the host audio device.
 * The shared mixer outputs float samples; WRITEPRIMARY bypasses this path.
 * Preserve in-range samples and the opt-in clipping diagnostics. */
